...
class EmailDFASpec extends FlatSpec {
  ...
  def correctEmailDFA[State, Symbol](dfa: DFA[State, Symbol]) = {
  ...
  "EmailDFA" should behave like correctEmailDFA(EmailDFA)
  "EmailHashDFA" should behave like correctEmailDFA(EmailDFA)
}
